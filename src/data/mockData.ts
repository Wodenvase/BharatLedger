...
export const demoCreditUsers = [
  {
    ...
    riskLevel: 'Low Risk',
    averageIncome: 35000,
    description: 'Stable salary earner, consistent EMI payments'
  },
  {
    id: '2',
    name: 'Rajesh Kumar',
    ...
    averageIncome: 42000,
    description: 'Freelancer, moderate spending, occasional delays'
  },
  {
    id: '3',
    name: 'Anjali Verma',
    ...
    riskLevel: 'High Risk',
    averageIncome: 28000,
    description: 'Retail worker, high utilization, missed payments'
  },
  {
    id: '4',
    name: 'Vikram Singh',
    ...
    averageIncome: 15000,
    description: 'Gig economy worker, erratic income, multiple defaults'
  },
  {
    id: '5',
    name: 'Deepika Patel',
    ...
    riskLevel: 'Low Risk',
    averageIncome: 65000,
    description: 'Senior professional, excellent credit, consistent income'
  }
];
