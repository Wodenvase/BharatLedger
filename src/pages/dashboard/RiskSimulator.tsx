...
const RiskSimulator: React.FC = () => {
  ...
  // Calculate actual baseline score from transactions
  useEffect(() => {
  ...
  const getScoreImpact = () => {
    const impact = simulatedScore - baselineScore;
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          {/* Simulated Score */}
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">Simulated Score</h2>
